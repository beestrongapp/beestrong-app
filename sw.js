const CACHE = 'beestrong-v76';
const ASSETS = ['./', './index.html', './manifest.json', './styles.css', './i18n.js', './storage.js', './workouts.js', './supabase.js', './push.js', './coach.js', './friends.js', './admin.js', './app.js', './whats-new.json', './logo.jpg', './light_logo.png', './shape.png', './icons/icon-192.png', './icons/icon-512.png', './icons/light-icon-192.png', './icons/light-icon-512.png', 'https://cdnjs.cloudflare.com/ajax/libs/Chart.js/4.4.1/chart.umd.js'];
