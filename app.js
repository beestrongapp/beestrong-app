    ...
    function exRow(e,i){
      ...
      return`<div class="tpl-edit-ex-card" data-reorder-item data-reorder-index="${i}" style="border:1px solid ${e.sup?'var(--accent-dim2)':'var(--border)'};border-radius:10px;padding:10px 12px;margin-bottom:8px;background:var(--bg3);">
        <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;">
          ...
          <button onclick="showExNoteModal(decodeURIComponent('${encodeURIComponent(exName(e))}'))" class="ex-info-btn workout-ex-note-btn${(S.exerciseNotes||{})[exName(e)]?' has-note':''}" title="${lang==='pl'?'Notatka':'Note'}" style="flex-shrink:0;"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg></button>
